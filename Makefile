...
LIBS=lib/mail.jar:lib/jmf.jar:lib/jnaerator-0.11-shaded.jar:lib/jna.jar:lib/platform.jar
LIBS2=lib/mail.jar:lib/jmf.jar:lib/jna.jar:lib/platform.jar
OPTS=-Dorg.lwjgl.opengl.Display.allowSoftwareOpenGL=false
SERVERCMDWIN=java -Xmx500m -Djava.library.path=lib -cp build;lib/groovy-1.8.6.jar;lib/jnaerator-0.12-shaded.jar;lib/jna.jar;lib/platform.jar;lib/mail.jar server.Server
...
createjars: compileofflineserver
	...
	cd build && jar cfm ../webroot/expsys/es.jar ../manifest.txt client util
